...
!((e, t) => {
  ...
  var $ = (function t() {
    const n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : K();
    const o = (e) => t(e);
    if (((o.version = "3.0.8"), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType))
    ...
    const ot = r.createElement("form"),
      ...
      it = function () {
        ...
        if (!nt || nt !== e) {
          if (
            ((e && "object" == typeof e) || (e = {}),
            (e = R(e)),
            (Je = -1 === Qe.indexOf(e.PARSER_MEDIA_TYPE) ? et : e.PARSER_MEDIA_TYPE),
            (tt = "application/xhtml+xml" === Je ? d : p),
            (he = "ALLOWED_TAGS" in e ? N({}, e.ALLOWED_TAGS, tt) : ge),
            (Te = "ALLOWED_ATTR" in e ? N({}, e.ALLOWED_ATTR, tt) : ye),
            ($e = "ALLOWED_NAMESPACES" in e ? N({}, e.ALLOWED_NAMESPACES, d) : Ze),
            (Ge = "ADD_URI_SAFE_ATTR" in e ? N(R(Ye), e.ADD_URI_SAFE_ATTR, tt) : Ye),
            (Be = "ADD_DATA_URI_TAGS" in e ? N(R(We), e.ADD_DATA_URI_TAGS, tt) : We),
            ...
            e.FORBID_CONTENTS && (He === ze && (He = R(He)), N(He, e.FORBID_CONTENTS, tt)),
            Ue && (he["#text"] = !0),
      ...
      Tt = (e) => "function" == typeof b && e instanceof b,
      yt = (e, t, n) => {
        ae[e] &&
          u(ae[e], (e) => {
            e.call(o, t, n, nt);
        ...
        for (; r--; ) {
          ...
          if (At(p, s, f)) {
            if (
              ...
              Q && "object" == typeof W && "function" == typeof W.getAttributeType)
            )
              if (l);
              else
