...
!((e, t) => {
  ...
  class w {
    ...
    table(e) {
      ...
      if (n.length === s.length) {
        ...
        for (const e of r)
          i.rows.push(
            d(e, i.header.length).map((e) => ({ text: e, tokens: this.lexer.inline(e) })),
          );
        return i;
      }
    }
        ...
        e.forEach((e) => {
          ...
          if (
            ...
            for (const n in e.renderer) {
              if (!(n in t) || "options" === n) throw new Error(`renderer '${n}' does not exist`);
              const s = n,
                r = e.renderer[s],
                i = t[s];
              t[s] = (...e) => {
          ...
          if (e.hooks) {
            ...
            for (const n in e.hooks) {
              if (!(n in t) || "options" === n) throw new Error(`hook '${n}' does not exist`);
              const s = n,
                r = e.hooks[s],
                i = t[s];
      ...
      return (n, s) => {
        ...
        if ((i.hooks && (i.hooks.options = i), i.async))
          return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n)
            .then((t) => e(t, i))
            .then((e) =>
              i.walkTokens ? Promise.all(this.walkTokens(e, i.walkTokens)).then(() => e) : e,
            )
            .then((e) => t(e, i))
  ...
  (ce.options = ce.setOptions =
    (e) => (ae.setOptions(e), (ce.defaults = ae.defaults), n(ce.defaults), ce)),
    (ce.getDefaults = t),
